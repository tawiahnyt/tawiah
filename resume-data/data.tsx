...
export const DATA = {
  personalData: {
    ...
    email: "davidtawiah.sh@gmail.com",
    phone: "+233 508968239",
    link: [
      {
        name: "github",
      ...
      {
        name: "x",
        url: "https://x.com/themilkyway",
      },
      {
        name: "instagram",
        url: "https://instagram.com/__tawiah",
      },
    ],
  ...
  educations: [
    {
      id: 1,
      year: "2020 - 2024",
      title: "Bachelor of Science in Information Technology (BIT)",
      school: "Ghana Communication Technology University",
      location: "Nsawam Rd, Accra, Ghana",
